...
1. As you scroll down, you may need to expand the **Checks** section. Then you will see the CI workflow running three separate jobs in detail.
    ...
    <img width="600" alt="image showing PR checks running" src="https://github.com/jinka06/skills-reusable-workflows/blob/main/.github/images/ci-checks-running.png?raw=true" />
